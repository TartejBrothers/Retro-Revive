...
Original file is located at
    https://colab.research.google.com/drive/1ArC-EFMx1G-8_nCl8VvjW7yrNFJBmpCP
"""
...
master_dir = '/content/drive/MyDrive/ImageColorization/data'
x = []
y = []
...
y = generator(test_x[11:33:7]).numpy()

for i in range(len(y)):
    plt.figure(figsize=(10, 10))
    colorized_image = plt.subplot(111)
    image = Image.fromarray((y[i] * 255).astype('uint8')).resize((1024, 1024))
    colorized_image.set_title('Colorized Output', fontsize=16)
    plt.imshow(image)
    plt.show()
...
save_model(generator, 'generator_model2.caffemodel')
